...
(defun color-theme-molokai-ob ()
  ...
  (color-theme-install
   '(color-theme-molokai-ob
     ...
     (css-selector ((t (:foreground "#bb1552"))))
     (css-property ((t (:foreground "#00afff"))))
     (diff-added ((t (:foreground "#A6E22E" :weight bold))))
     (diff-context ((t (:foreground "#F8F8F2"))))
     (diff-file-header ((t (:foreground "#00afff" :background nil))))
     (diff-indicator-added ((t (:foreground "#A6E22E"))))
     (diff-indicator-removed ((t (:foreground "#bb1552"))))
     (diff-header ((t (:foreground "#F8F8F2" :background "#232526"))))
     (diff-hunk-header ((t (:foreground "#AE81FF" :background "#232526"))))
     (diff-removed ((t (:foreground "#bb1552"))))
     (diff-refine-change ((t (:background "#303030"))))
     (escape-glyph ((t (:foreground "#E6DB74"))))
     (minibuffer-prompt ((t (:foreground "#87afff"))))
     (mode-line ((t (:foreground "#5f5faf" :background "#1c1c1c"))))
     (mode-line-inactive ((t (:foreground "#5f5f5f" :background "#1c1c1c"))))
     (font-lock-builtin-face ((t (:foreground "#A6E22E"))))
     (font-lock-comment-face ((t (:foreground "#5f5f5f" :slant italic))))
     (font-lock-comment-delimiter-face ((t (:foreground "#5f5f5f" :slant italic))))
     (font-lock-constant-face ((t (:foreground "#af87ff"))))
     (font-lock-doc-face ((t (:foreground "#E6DB74" :slant italic))))
     (font-lock-function-name-face ((t (:foreground "#af87ff" :weight bold))))
     (font-lock-keyword-face ((t (:foreground "#d7005f" :weight bold))))
     (font-lock-negation-char-face ((t (:weight bold))))
     (font-lock-preprocessor-face ((t (:foreground "#87ff5f" :weight bold))))
     (font-lock-regexp-grouping-backslash ((t (:weight bold))))
     (font-lock-regexp-grouping-construct ((t (:weight bold))))
     (font-lock-string-face ((t (:foreground "#ffff87"))))
     (font-lock-type-face ((t (:foreground "#5fafff"))))
     (font-lock-variable-name-face ((t (:foreground "#d7005f" :weight bold))))
     ...
     (icompletep-choices ((t (:foreground "#bb1552"))))
     (icompletep-determined ((t (:foreground "#A6E22E"))))
     (icompletep-keys ((t (:foreground "#bb1552"))))
     ...
     (woman-bold ((t (:foreground "#bb1552"))))
     (woman-italic ((t (:foreground "#A6E22E"))))
     (woman-unknown ((t (:foreground "#66D9EF"))))
     (linum ((t (:background "#101010" :foreground "#5f87af" :underline nil :slant normal :weight normal))))
     (linum-terminal-seperator ((t (:background "#1c1c1c" :underline nil))))
     (tabbar-default ((t (:background "#1c1c1c" :underline nil :weight normal))))
     (tabbar-unselected ((t (:background "#1c1c1c" :foreground "#5f5f5f" :underline nil :weight normal))))
     (tabbar-selected ((t (:background "#1c1c1c" :foreground "#d7005f" :underline nil :weight bold))))
     (tabbar-button ((t (:background "#1c1c1c" :foreground "#5f5f5f" :underline nil))))
