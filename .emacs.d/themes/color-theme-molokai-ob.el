...
(defun color-theme-molokai-ob ()
  ...
  (color-theme-install
   '(color-theme-molokai-ob
     ...
     (default ((t (:foreground "#66ff66" :background "#202020"))))
     (bold ((t (:weight bold))))
     ...
     (mode-line ((t (:foreground "#543e7b" :background "#101010"))))
     ...
     (tabbar-selected ((t (:background "#101010" :foreground "#bb1553" :underline nil :weight bold))))
