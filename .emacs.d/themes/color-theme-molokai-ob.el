...
(defun color-theme-molokai-ob ()
  ...
  (color-theme-install
   '(color-theme-molokai-ob
     ...
     (font-lock-function-name-face ((t (:foreground "#bb1553"))))
     (font-lock-keyword-face ((t (:foreground "#bb1553" :weight bold))))
     (font-lock-negation-char-face ((t (:weight bold))))
     (font-lock-preprocessor-face ((t (:foreground "#A6E22E"))))
     (font-lock-regexp-grouping-backslash ((t (:weight bold))))
     (font-lock-regexp-grouping-construct ((t (:weight bold))))
     (font-lock-string-face ((t (:foreground "#E6DB74"))))
     (font-lock-type-face ((t (:foreground "#00d7ff"))))
     (font-lock-variable-name-face ((t (:foreground "#bb1552"))))
