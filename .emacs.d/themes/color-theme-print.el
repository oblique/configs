...
(defun color-theme-print ()
  ...
  (color-theme-install
   '(color-theme-print
     ...
     (rainbow-delimiters-depth-1-face ((t (:foreground "#d52650")))) ; red
     (rainbow-delimiters-depth-2-face ((t (:foreground "#d52650"))))
     (rainbow-delimiters-depth-3-face ((t (:foreground "#d52650"))))
     (rainbow-delimiters-depth-4-face ((t (:foreground "#d52650"))))
     (rainbow-delimiters-depth-5-face ((t (:foreground "#d52650"))))
     (rainbow-delimiters-depth-6-face ((t (:foreground "#d52650"))))
     (rainbow-delimiters-depth-7-face ((t (:foreground "#d52650"))))
     (rainbow-delimiters-depth-8-face ((t (:foreground "#d52650"))))
     (rainbow-delimiters-depth-9-face ((t (:foreground "#d52650"))))
     )))
