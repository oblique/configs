...
--------------------------------
To GTK3 apps
Edit the file ../FlatStudioLight/gtk-3.0/gtk.css
on line 24 assigns the value of desired color
@define-color theme_selected_bg_color 		@selection_mono;


for GTK2 apps
Edit the file .. /FlatStudioLight/gtk-2.0/gtkrc
...
* 3.- Select style for nautilus *
---------------------------------
Edit (gedit) the file ../FlatStudioLight/gtk-3.0/gtk.css
